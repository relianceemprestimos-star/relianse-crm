...
export class ErrorBoundary extends Component<Props, State> {
  ...
  override componentDidCatch(error: Error) {
    ...
    console.error('Relianse CRM render error:', error);
  }
      ...
      return (
        <div className="min-h-screen bg-bg px-6 py-10 text-slate-100">
          <div className="mx-auto max-w-3xl rounded-3xl border border-danger/30 bg-panel p-6 shadow-glow">
            ...
            <h1 className="mt-2 text-2xl font-bold text-white">A tela não carregou corretamente</h1>
            <p className="mt-3 text-sm text-slate-300">
              Ocorreu um erro ao renderizar a página. Copie a mensagem abaixo e me envie para eu corrigir exatamente a causa.
            </p>
